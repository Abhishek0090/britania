...
const GraphData = ({ dateFilters, setDateFilters, paginatedCryptoOrders }) => {
...
//     (totalData.total_marks_obtained / totalData.total_marks_out_of) * 100;
  ...
  useEffect(() => {
    ...
    paginatedCryptoOrders?.forEach((item) => {
      const affiliate_data = item?.paid_status;
...
//   }, [paginatedCryptoOrders]);
  ...
  return (
    <div className="flex md:flex-row flex-col items-center md:items-center  justify-center  gap-5 md:gap-2 py-5">
      {" "}
      <div>
