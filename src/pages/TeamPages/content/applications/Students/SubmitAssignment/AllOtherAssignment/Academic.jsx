...
const relevantType = ["Lor", "Sop", "Resume", "Cover Letter"];
...
export default function Academic() {
  ...
  const studentData = useSelector((state) => state.student.allAcademicDetails);
  ...
  const handleUploadFiles = async (files) => {
    ...
    await axios
      .post(
        `${URL}/student/fileuploadsubmitassignmentacademicwriting.php`,
        data,
        {
          headers: {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const data = {
        ...
        domain: "Freelancer Academic Writing",
        stream: "Academic Writing",
        submit: "submit",
      };
      ...
      await axios
        .post(`${URL}/team/submitassignmentacademicwriting.php`, data)
        .then((res) => {
          console.log(res);
          toast.success("Assignment Posted Successfully");
          dispatch(clearAllAcademicDetails());
                ...
                renderInput={(params) => (
                  ...
                  >
                    ...
                    <OutlinedInput
                      ...
                      {...params}
                      placeholder="Select The Deadline of Assignment"
                      label="Deadline for the assignment"
                    />
                  </FormControl>
                )}
                  ...
                  <>
                    {loading ? (
                      ...
                      >
                        ...
                        <span className="cURLtalize">Please wait...</span>
                      </div>
                    ) : (
                      <>
                        <svg
