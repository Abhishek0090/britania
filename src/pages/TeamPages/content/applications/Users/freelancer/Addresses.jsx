...
function Addresses({ user, id }) {
  ...
  return (
    <Grid
      ...
      spacing={3}
    >
      {user?.technical_status?.form_filled === '1' ? (
      ...
      {user?.non_technical_status?.form_filled === '1' ? (
        <Grid item xs={12} sm={12} md={12}>
          <Card>
                        ...
                        <FormControlLabel
                          control={
                            <CheckboxWrapper
                              color="primary"
                              disabled={
                                non_technical?.interview_conducted ||
                                auth?.teamDomain === 'Non-Technical pm'
                              }
                        ...
                        <FormControlLabel
                          control={
                            <CheckboxWrapper
                              color="primary"
                              disabled={
                                non_technical?.agreement_received ||
                                auth?.teamDomain === 'Non-Technical pm'
                              }
