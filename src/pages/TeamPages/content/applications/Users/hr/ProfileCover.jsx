...
const ProfileCover = ({ user, id }) => {
  ...
  const handleChatCreate = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        navigate(
          `/team/dashboards/chats?chat_id=${res.chat_id}&type=TeamandFreelancerPersonal&new_chat=new`
        );
      })
  ...
  const handleGoToChat = () => {
    // navigate(
    //   `/team/dashboards/chats?chat_id=${user.chat_id}&type=TeamandFreelancerPersonal`
    // );
  };
