...
const TotalFilteredCard = ({ totalData }) => {
  ...
  return (
    <div className="flex md:flex-row flex-col items-center md:items-center  justify-between px-10 md:px-2 gap-1 md:gap-2 py-3">
      {" "}
      ...
      <div className="flex gap-2 items-center">
        ...
        <span className="text-sm">{total_marks_out_of_100}</span>
      </div>
      <div className="flex gap-2 items-center">
