...
import { useNonTechnicalFreelancerSignUpMutation } from "~/features/freelancer/freelancerApiSlice";
import {
...
export default function PersonalDetails() {
  ...
  const [freelancerSignUp] = useNonTechnicalFreelancerSignUpMutation();
  ...
  const handleCheckValid = () => {
    ...
    axios
      .post(`${URL}/freelancer/freelancersignupcheck.php`, data, {
        headers: {
